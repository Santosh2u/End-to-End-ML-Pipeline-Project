...
#Initialise Absolute paths for the models and the data
BASE_DIR = os.path.dirname(os.path.abspath(__file__))
model_path1 = os.path.join(BASE_DIR, "..", "models", "linear_regression_model.joblib")
model_path2 = os.path.join(BASE_DIR, "..", "models", "decision_tree_model.joblib")
model_path3 = os.path.join(BASE_DIR, "..", "models", "random_forest_model.joblib")
model_path4 = os.path.join(BASE_DIR, "..", "models", "scaler.joblib")
datapath = os.path.join(BASE_DIR, "..", "data", "Data_Long.csv")

# Load the trained models
linear_model = joblib.load(model_path1)
decision_tree_model = joblib.load(model_path2)
random_forest_model = joblib.load(model_path3)
scaler = joblib.load(model_path4)  # Load the scaler used during training
